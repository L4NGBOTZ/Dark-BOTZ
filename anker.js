...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:DARK BOT\n'
            + 'ORG:Owner Gans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6285282775166:+62 852-8277-5166\n'
            + 'END:VCARD'
...
limitt = 9999
memberLimit = 2
ban = ["6289694294363@s.whatsapp.net"]
premium = ["6285282775166@s.whatsapp.net"]
...
async function starts() {
	...
	dms.on('chat-update', async (mek) => {
		try {
			...
			const BotWea2 = ["085282775166@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				wait: '*⏳ SABAR LAGI DI BUAT*',
				success: '*DAH SUKSES BRO*',
				error: {
					stick: ' *𝗠𝗔𝗔𝗙 𝗧𝗘𝗥𝗝𝗔𝗗𝗜 𝗞𝗘𝗦𝗔𝗟𝗔𝗛 𝗦𝗔𝗔𝗧 𝗖𝗢𝗡𝗩𝗘𝗥𝗧 𝗧𝗢 𝗦𝗧𝗜𝗖𝗞𝗘𝗥*',
					Iv: '*𝗠𝗔𝗔𝗙 𝗟𝗜𝗡𝗞 𝗧𝗜𝗗𝗔𝗞 𝗩𝗔𝗟𝗜𝗗!!*'
				},
				only: {
					group: '*Sedang Menunggu!*',
					benned: '*SORRY BRO LU UDH KENA BANNED!*',
					ownerG: '*OWNER GANS NIH BOUS!*',
					ownerB: '*LU MANA BISA AJG, KHUSUS SI GALANG: V* ',
					premium: '*PREMIUM NIH BOUS, KALIAN GA MAU PREM?!*',
					userB: `*Hallo Kak* ${pushname2} *Kayanya Kamu Blm Terdaftar Sebagai Teman Dark BOT*\n*Ketik ${prefix}daftar nama|umur*\n*Contoh ${prefix}daftar galang|17*`,
					admin: '*ADMIN NYA GANS SEMUA:V!*',
			...
			const ownerNumber = ["6285282775166@s.whatsapp.net"] // owner number ubah aja
